...
import com.ffo.ipiker.util.AutoFitTextureView;
...
public class Camera2Activity extends BaseActivity implements View.OnClickListener {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture,
            ...
            mWidth = width;
            mHeight = height;
            if (ActivityCompat.checkSelfPermission(Camera2Activity.this, VIDEO_PERMISSIONS[0])
                    != PackageManager.PERMISSION_GRANTED || ActivityCompat.checkSelfPermission
                    (Camera2Activity.this, VIDEO_PERMISSIONS[1])
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(Camera2Activity.this, VIDEO_PERMISSIONS, 1);
            } else {
...
//            thread.start();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_VIDEO_PERMISSIONS) {
            if (grantResults.length == VIDEO_PERMISSIONS.length && grantResults[0] ==
                    PackageManager.PERMISSION_GRANTED) {
    ...
    private String getVideoFilePath(Context context) {
        ...
        String main = Environment.getExternalStorageDirectory().getPath() + File.separator +
                "IPIKER";
        File destDir = new File(main);
        if (!destDir.exists()) {
            destDir.mkdirs();//在根创建了文件夹IPIKER
        }
        String toFile = main + File.separator + System.currentTimeMillis() + ".mp4";
...
////                好像可以得到字节数组
////                Image.Plane[] plan = image.getPlanes();
////                ByteBuffer bytes = plan[0].getBuffer();
