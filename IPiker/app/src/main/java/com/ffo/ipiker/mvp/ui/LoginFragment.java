...
import com.ffo.ipiker.fragment.CallFragmentValue;
import com.ffo.ipiker.mvp.IPresenter;
import com.ffo.ipiker.mvp.contract.LoginContract;
import com.ffo.ipiker.mvp.presenter.LoginPresenter;
...
public class LoginFragment extends BasePresenterFragment<LoginPresenter> implements View.OnClickListener,
        LoginContract.IView {
    ...
    @Override
    protected void parseArgumentsFromIntent() {
    ...
    private void loginOperation() {
        ...
        mPresenter.login(accoutStr,passwordStr);
    }
    ...
    @Override
    public void checkFormatResult(int type, String msg) {
